      ...
      <div className="p-6">
        {activeTab === "paste" ? (
          <div>
            <div className="text-center mb-4">
              <p className="text-gray-600 dark:text-gray-300">Paste your speech text below for analysis</p>
            </div>
            <textarea
              value={text}
        ...
        <div className="mt-6 flex justify-center">
          <motion.button
            ...
            className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-lg transition-all flex items-center gap-2"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            disabled={activeTab === "paste" ? !text.trim() : !file}
          >
            <FileText size={18} />
            Analyze Text
          </motion.button>
